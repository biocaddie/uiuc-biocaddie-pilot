...
qrelsData <- read.table("/shared/trecgenomics/qrels/trecgenomics-qrels.txt", header=F,col.names=c("query", "ID", "docno", "relno"),sep="\t")
...
write.table(nondup_qrelsData,"/shared/trecgenomics/qrels/trecgenomics-qrels-nondup.txt",sep="\t",row.names=FALSE, col.names=FALSE) 
