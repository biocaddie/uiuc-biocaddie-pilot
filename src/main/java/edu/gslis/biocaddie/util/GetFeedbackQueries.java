...
/**
 * Given a set of topics and an index, generate RM3 feedback queries and write
 * to an output file.
 */
public class GetFeedbackQueries {
	...
	public static void main(String[] args) throws ParseException, IOException {
		...
		/*
		 * <parameters> <query> <number>EA1</number> <text>Find data of all
		 * types related to TGF-β signaling pathway across all databases</text>
		 * </query> </parameters>
		 */
		...
		while (queryIterator.hasNext()) {
			...
			FeatureVector feedbackVector = FeatureVector.interpolate(queryVector, rmVector, rmLambda);
			...
			/*
			 * <parameters> <query> <number>EA1</number> <text>Find data of all
			 * types related to TGF-β signaling pathway across all
			 * databases</text> </query> </parameters>
			 */
