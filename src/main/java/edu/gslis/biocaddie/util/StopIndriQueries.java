...
public class StopIndriQueries 
{
    ...
    public static void main(String[] args) throws ParseException, IOException {
        ...
        if (cl.hasOption("help")) {
            ...
            formatter.printHelp( StopIndriQueries.class.getCanonicalName(), options );
            return;
        }
        ...
        process(inputFile, outputFile, stopper);
    }
    
    public static void process(File inputFile, File outputFile, Stopper stopper) 
            throws IOException {
                           ...
                           if (node != null) {
                               ...
                               if (!tag.equals("#text")) {
                                   if (node.getFirstChild() != null)
                                   {
                                       ...
                                       if (tag.equals("text"))
                                           outputWriter.write("<" + tag + ">" + stop(content, stopper) + "</" + tag + ">\n"); 
                                       else
