      ...
      do
         ...
         do 
            ...
            do
               ...
               do
                   echo "IndriRunQuery -index=$base/indexes/biocaddie_all/ -trecFormat=true -baseline=okapi,k1:$k1,k3:$k3,b:$b -fbDocs=$fbDocs -fbTerms=$fbTerms -fbOrigWeight=$fbOrigWeight queries/queries.$col.$topics > output/okapi-exp/$col/$topics/k1=$k1:k3=$k3:b=$b:fbTerms=$fbTerms:fbDocs=$fbDocs:fbOrigWeight=$fbOrigWeight.out"
               done
            done
         done
      done
