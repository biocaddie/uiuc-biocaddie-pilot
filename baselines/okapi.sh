...
do
   ...
   do 
      ...
      do 
         IndriRunQuery -index=$base/indexes/biocaddie_all/ -trecFormat=true -baseline=okapi,k1:$k1,k3:$k3,b:$b queries/queries.$col.$topics > output/okapi/$col/$topics/k1=$k1:k3=$k3:b=$b.out
      done
   done
done
